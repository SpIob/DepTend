/**
 * PyPIIngestor — HTTP-based ingestor for PyPI ecosystem.
 *
 * Thin re-export of createHttpIngestor factory with PyPI-specific config.
...
export const PyPIIngestor = createHttpIngestor({
  ecosystem: "pypi",
